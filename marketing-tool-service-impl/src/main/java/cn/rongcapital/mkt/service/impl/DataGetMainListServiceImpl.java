...
public class DataGetMainListServiceImpl implements DataGetMainListService {
    ...
    @Override
    public Object getMainList(String method, String userToken, Integer dateType, Integer index,
    ...
    private void assignDataByDataType(int dateType, BaseOutput rseult, int index, int size) {

        if (dateType == DataTypeEnum.PARTY.getCode()) {
            ...
            if (partyList != null && !partyList.isEmpty()) {
                for (DataParty dataParty : partyList) {
                    ...
                    map.put("offline_activity_attendence",
                                    dataParty.getOfflineActivityAttendence());
