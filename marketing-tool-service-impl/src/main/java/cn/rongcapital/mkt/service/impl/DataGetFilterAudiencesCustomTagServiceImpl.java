...
@Service
public class DataGetFilterAudiencesCustomTagServiceImpl implements DataGetFilterAudiencesStrategyService{
	...
	public <T extends BaseQuery> Map<String,Object> getData(Integer mdType,
		...
		List<DataCustomerTags> dataList = dataCustomerTagsDao.selectByBatchId(paramMap);
		...
		if (dataList != null && !dataList.isEmpty()) {
			...
			for (DataCustomerTags tempT : dataList) {
	...
	public Integer getAudiencesCount(Map<String, Object> paramMap ){
		...
		return dataCustomerTagsDao.getAudiencesCount(paramMap);
	...
	public List<String> getAudiencesIds(Map<String, Object> paramMap){
		...
		return dataCustomerTagsDao.selectMappingKeyIds(paramMap);	
	}
	...
	private <D extends BaseDataFilterDao<?>> List<Integer> filterContactId(List<Integer> contactIdList) {
		...
		for (Integer contactId : contactIdList) {
			...
			if (columnName == null) {
				...
				List<String> columnNameList = dataCustomerTagsDao.selectColumns();
