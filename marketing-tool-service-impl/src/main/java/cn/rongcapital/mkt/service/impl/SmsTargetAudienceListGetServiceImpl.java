...
public class SmsTargetAudienceListGetServiceImpl implements SmsTargetAudienceListGetService{
    ...
    @Override
    public SmsTargetAudienceListOut getSmsTargetAudienceList(Integer orgId, Boolean firsthand) {
        ...
        paramSegmentationHead.setFirsthand(firsthand);
        ...
        paramAudienceList.setFirsthand(firsthand);
