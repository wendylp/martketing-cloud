package cn.rongcapital.mkt.service.impl.test;
...
public class WechatQrcodeActivateServiceTest  {
	...
	public WechatQrcodeActivateServiceImpl wechatQrcodeActivateService; 
	
	public WechatQrcodeDao wechatQrcodeDao ;
	...
	public void testWeChatQrocdeActivate()	{		
		...
		//获取service方法执行结果
		logger.info("TotalCount="+baseOutPut.getTotalCount());
