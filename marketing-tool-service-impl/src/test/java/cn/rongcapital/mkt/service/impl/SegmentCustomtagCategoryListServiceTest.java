...
public class SegmentCustomtagCategoryListServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        Mockito.when(mongoCustomTagDao.countValidCustomTagAndCoverNumber(any())).thenReturn(customTagCount);

        segmentCustomtagCategoryListService = new SegmentCustomtagCategoryListServiceImpl();

        ReflectionTestUtils.setField(segmentCustomtagCategoryListService, "mongoCustomTagCategoryDao",
                mongoCustomTagCategoryDao);
        ReflectionTestUtils.setField(segmentCustomtagCategoryListService, "mongoCustomTagDao", mongoCustomTagDao);
    }
    ...
    @Test
    public void testGetSegmentCustomTagCategoryList() {
        BaseOutput baseOutput = segmentCustomtagCategoryListService.getSegmentCustomTagCategoryList();
        ...
        Assert.assertEquals(customTagCategoryLists.get(1).getCustomTagCategoryId(),
                customTagCategoryOut.getCustomTagCategoryId());
