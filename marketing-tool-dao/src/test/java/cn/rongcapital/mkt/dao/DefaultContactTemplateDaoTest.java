...
public class DefaultContactTemplateDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: DefaultContactTemplateDao 开始---------------------");
    }
    
	@Test
	public void testSelectKeyByContactId() {
	    logger.info("测试方法: selectKeyByContactId ");    
	}
    ...
    public void tearDown() throws Exception {
        logger.info("测试: DefaultContactTemplateDao 结束---------------------");
    }
}