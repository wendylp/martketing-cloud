...
public class IllegalDataDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: IllegalDataDao 开始---------------------");
    }
	...
	@Test
	public void testUpdateStatusByBatchIdAndType() {
	    logger.info("测试方法: updateStatusByBatchIdAndType ");    
	}
    ...
    public void tearDown() throws Exception {
        logger.info("测试: IllegalDataDao 结束---------------------");
    }
}