...
public class CampaignActionSendPrivtDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: CampaignActionSendPrivtDao 开始---------------------");
    }
    ...
    public void tearDown() throws Exception {
        logger.info("测试: CampaignActionSendPrivtDao 结束---------------------");
    }
}