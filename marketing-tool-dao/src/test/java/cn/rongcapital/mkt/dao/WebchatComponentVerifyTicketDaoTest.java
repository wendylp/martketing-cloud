...
public class WebchatComponentVerifyTicketDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: WebchatComponentVerifyTicketDao 开始---------------------");
    }
    ...
    public void tearDown() throws Exception {
        logger.info("测试: WebchatComponentVerifyTicketDao 结束---------------------");
    }
}