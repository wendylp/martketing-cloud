...
public class DatareportColumnsDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: DatareportColumnsDao 开始---------------------");
    }
    
	@Test
	public void testSelectListByFieldOrder() {
	    logger.info("测试方法: selectListByFieldOrder ");    
	}
    ...
    public void tearDown() throws Exception {
        logger.info("测试: DatareportColumnsDao 结束---------------------");
    }
}