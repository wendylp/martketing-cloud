...
public class OriginalDataPopulationDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: OriginalDataPopulationDao 开始---------------------");
    }
    ...
    public void tearDown() throws Exception {
        logger.info("测试: OriginalDataPopulationDao 结束---------------------");
    }
}