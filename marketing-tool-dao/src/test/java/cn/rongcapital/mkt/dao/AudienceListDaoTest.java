...
public class AudienceListDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: AudienceListDao 开始---------------------");
    }
    
	@Test
	public void testInsertAudience() {
	...
	@Test
	public void testSelectAudienceCount() {
	    logger.info("测试方法: selectAudienceCount ");    
	}
	
	@Test
	public void testInsertWechatGroups() {
	    logger.info("测试方法: insertWechatGroups ");    
	}
	
	@Test
	public void testSelectIdByAudienceName() {
	    logger.info("测试方法: selectIdByAudienceName ");    
	}
