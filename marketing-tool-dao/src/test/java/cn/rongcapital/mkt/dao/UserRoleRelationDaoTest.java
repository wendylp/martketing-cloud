...
import cn.rongcapital.mkt.dao.UserRoleRelationDao;
...
public class UserRoleRelationDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: UserRoleRelationDao 开始---------------------");
    }
    ...
    public void tearDown() throws Exception {
        logger.info("测试: UserRoleRelationDao 结束---------------------");
    }
}