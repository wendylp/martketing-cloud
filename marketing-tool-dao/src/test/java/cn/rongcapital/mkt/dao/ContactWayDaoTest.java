...
public class ContactWayDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: ContactWayDao 开始---------------------");
    }
    
	@Test
	public void testSelectAllContactWay() {
	    logger.info("测试方法: selectAllContactWay ");    
	}
    ...
    public void tearDown() throws Exception {
        logger.info("测试: ContactWayDao 结束---------------------");
    }
}