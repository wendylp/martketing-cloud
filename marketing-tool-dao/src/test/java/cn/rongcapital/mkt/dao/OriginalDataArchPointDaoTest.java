...
public class OriginalDataArchPointDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: OriginalDataArchPointDao 开始---------------------");
    }
    
	@Test
	public void testBatchCleanData() {
	    logger.info("测试方法: batchCleanData ");    
	}
    ...
    public void tearDown() throws Exception {
        logger.info("测试: OriginalDataArchPointDao 结束---------------------");
    }
}