...
public class CampaignDecisionPubFansDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: CampaignDecisionPubFansDao 开始---------------------");
    }
    ...
    public void tearDown() throws Exception {
        logger.info("测试: CampaignDecisionPubFansDao 结束---------------------");
    }
}