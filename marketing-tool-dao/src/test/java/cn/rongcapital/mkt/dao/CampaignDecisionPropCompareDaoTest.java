...
public class CampaignDecisionPropCompareDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: CampaignDecisionPropCompareDao 开始---------------------");
    }
    ...
    public void tearDown() throws Exception {
        logger.info("测试: CampaignDecisionPropCompareDao 结束---------------------");
    }
}