...
import cn.rongcapital.mkt.dao.WechatPublicDao;
...
public class WechatPublicDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: WechatPublicDao 开始---------------------");
    }
    ...
    public void tearDown() throws Exception {
        logger.info("测试: WechatPublicDao 结束---------------------");
    }
}