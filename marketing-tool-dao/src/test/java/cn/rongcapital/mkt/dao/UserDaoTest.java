...
public class UserDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: UserDao 开始---------------------");
    }
    
	@Test
	public void testUpdatePasswd() {
	    logger.info("测试方法: updatePasswd ");    
	}
	
	@Test
	public void testValidateLoginInput() {
	    logger.info("测试方法: validateLoginInput ");    
	}
	
	@Test
	public void testGetRoleIdAndUserName() {
	    logger.info("测试方法: getRoleIdAndUserName ");    
	}
