...
public class TagRecommendDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: TagRecommendDao 开始---------------------");
    }
    
	@Test
	public void testFuzzySearch() {
	    logger.info("测试方法: fuzzySearch ");    
	}
    ...
    public void tearDown() throws Exception {
        logger.info("测试: TagRecommendDao 结束---------------------");
    }
}