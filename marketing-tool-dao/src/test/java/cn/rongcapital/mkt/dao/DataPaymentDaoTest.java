...
public class DataPaymentDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: DataPaymentDao 开始---------------------");
    }
    
	@Test
	public void testSelectAverageIncomeAmountByWechatInfo() {
	    logger.info("测试方法: selectAverageIncomeAmountByWechatInfo ");    
	}
	
	@Test
	public void testSelectTotalIncomeAmountByWechatInfo() {
	    logger.info("测试方法: selectTotalIncomeAmountByWechatInfo ");    
	}
	...
	@Test
	public void testSelectWxCodeIsNullStatus() {
	    logger.info("测试方法: selectWxCodeIsNullStatus ");    
	}
	
	@Test
	public void testSelectTotalIncomeAmountByKeyid() {
	    logger.info("测试方法: selectTotalIncomeAmountByKeyid ");    
	}
	...
	@Test
	public void testSelectAverageIncomeAmountByKeyid() {
	    logger.info("测试方法: selectAverageIncomeAmountByKeyid ");    
	}
    ...
    public void tearDown() throws Exception {
        logger.info("测试: DataPaymentDao 结束---------------------");
    }
}