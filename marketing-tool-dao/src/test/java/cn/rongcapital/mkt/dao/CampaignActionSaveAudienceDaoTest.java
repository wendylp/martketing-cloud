...
public class CampaignActionSaveAudienceDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: CampaignActionSaveAudienceDao 开始---------------------");
    }
    ...
    public void tearDown() throws Exception {
        logger.info("测试: CampaignActionSaveAudienceDao 结束---------------------");
    }
}