...
public class RoleResourceMapDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: RoleResourceMapDao 开始---------------------");
    }
    
	@Test
	public void testSelectResourceIds() {
	    logger.info("测试方法: selectResourceIds ");    
	}
    ...
    public void tearDown() throws Exception {
        logger.info("测试: RoleResourceMapDao 结束---------------------");
    }
}