...
import cn.rongcapital.mkt.dao.OperationLogDao;
...
public class OperationLogDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: OperationLogDao 开始---------------------");
    }
    ...
    public void tearDown() throws Exception {
        logger.info("测试: OperationLogDao 结束---------------------");
    }
}