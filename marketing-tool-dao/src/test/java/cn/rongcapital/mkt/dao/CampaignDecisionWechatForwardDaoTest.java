...
public class CampaignDecisionWechatForwardDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: CampaignDecisionWechatForwardDao 开始---------------------");
    }
    ...
    public void tearDown() throws Exception {
        logger.info("测试: CampaignDecisionWechatForwardDao 结束---------------------");
    }
}