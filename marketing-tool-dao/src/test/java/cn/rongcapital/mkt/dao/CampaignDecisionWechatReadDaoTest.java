...
public class CampaignDecisionWechatReadDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: CampaignDecisionWechatReadDao 开始---------------------");
    }
    ...
    public void tearDown() throws Exception {
        logger.info("测试: CampaignDecisionWechatReadDao 结束---------------------");
    }
}