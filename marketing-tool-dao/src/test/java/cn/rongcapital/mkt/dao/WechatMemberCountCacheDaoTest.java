...
public class WechatMemberCountCacheDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: WechatMemberCountCacheDao 开始---------------------");
    }
    
	@Test
	public void testSelectCountByTypeAndTimeIndex() {
	    logger.info("测试方法: selectCountByTypeAndTimeIndex ");    
	}
    ...
    public void tearDown() throws Exception {
        logger.info("测试: WechatMemberCountCacheDao 结束---------------------");
    }
}