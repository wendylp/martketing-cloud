...
public class TaskRunLogDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: TaskRunLogDao 开始---------------------");
    }
    
	@Test
	public void testSelectLastOne() {
	    logger.info("测试方法: selectLastOne ");    
	}
	
	@Test
	public void testSelectByEndtime() {
	    logger.info("测试方法: selectByEndtime ");    
	}
	
	@Test
	public void testTaskRunLogList() {
	    logger.info("测试方法: taskRunLogList ");    
	}
    ...
    public void tearDown() throws Exception {
        logger.info("测试: TaskRunLogDao 结束---------------------");
    }
}