...
public class CampaignActionSendPubDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: CampaignActionSendPubDao 开始---------------------");
    }
	...
	@Test
	public void testSelectImgAssetName() {
	    logger.info("测试方法: selectImgAssetName ");    
	}
    ...
    public void tearDown() throws Exception {
        logger.info("测试: CampaignActionSendPubDao 结束---------------------");
    }
}