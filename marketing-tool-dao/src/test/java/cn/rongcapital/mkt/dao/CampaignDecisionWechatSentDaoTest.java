...
public class CampaignDecisionWechatSentDaoTest extends AbstractUnitTest {
    ...
    public void setUp() throws Exception {
        logger.info("测试: CampaignDecisionWechatSentDao 开始---------------------");
    }
    ...
    public void tearDown() throws Exception {
        logger.info("测试: CampaignDecisionWechatSentDao 结束---------------------");
    }
}