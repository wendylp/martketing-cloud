...
public class ContactsCommitSaveIn  extends BaseInput {
	...
	public Integer getContact_templ_id() {
		return contact_templ_id;
	}

	public void setContact_templ_id(Integer contact_templ_id) {
		this.contact_templ_id = contact_templ_id;
	}
}
