...
public interface SmsTaskHeadService {
	 ...
	 * @return
	 */
	public BaseOutput smsTaskHeadList(String userId, Integer index, Integer size, String smsTaskAppType,String smsTaskStatus, String smsTaskName, Integer orgId) throws Exception;
